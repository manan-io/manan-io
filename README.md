...
const engineeringPrinciples = {
  ...
  philosophy:
    "Build systems that are easy to understand, hard to break, and simple to scale."
};
```
...
- I enjoy optimizing applications for performance.
...
<p align="center">
  <i>Building software one abstraction layer at a time.</i>
</p>
